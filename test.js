...
test('Test byDays', function (t) {

  var days = groupByTime.byDay(data, 'ts');
...
test('Test byWeeks', function (t) {

  var weeks = groupByTime.byWeek(data, 'ts');
...
test('Test byMonths', function (t) {

  var months = groupByTime.byMonth(data, 'ts');
